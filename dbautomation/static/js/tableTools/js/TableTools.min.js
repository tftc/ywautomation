...
break;case "mouseover":this.domElement&&this.cssEffects&&this.recover&&this.domElement.addClass("");break;case "mouseout":this.domElement&&this.cssEffects&&(this.recover=!1,this.domElement.hasClass("")&&(this.domElement.removeClass(""),this.recover=!0));break;case "mousedown":this.domElement&&this.cssEffects&&this.domElement.addClass("");break;case "mouseup":this.domElement&&this.cssEffects&&(this.domElement.removeClass(""),this.recover=!1)}if(this.handlers[a])for(var d=
